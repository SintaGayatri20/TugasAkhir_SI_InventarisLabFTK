         ...
         <div class="col-lg">
             <div class="content-wrapper">
                 <section class="content">
                     <form action="<?php echo base_url() . 'admin/newEditDataAset'; ?>" method="post" enctype="multipart/form-data">
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" name="nama_barang" class="form-control" value="<?= $asetData->nama_barang ?>" required>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" name="jumlah" class="form-control" value="<?= $asetData->jumlah ?>" required>
                         </div>
                         <div class="form-group">
                             <label for="">Satuan</label>
                             <input type="text" name="satuan" class="form-control" value="<?= $asetData->satuan ?>" required>
                         </div>
                         <div class="form-group">
                         ...
                         <a class="btn btn-warning" href="<?= base_url('admin/dataAset'); ?>">Back</a>
                     </form>
                 </section>
             </div>
         </div>
