<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Form Pengadaan Bahan Habis Pakai Ruanga</h1>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="card border-bottom-info shadow h-100 py-3">
                    <form class="form-horizontal" action="<?php echo base_url('Koorlab/perbaikanAsetRusak'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="submit" value="Pilih Alat" name="submit" class="btn btn-primary" style="float:right">
                            </div>
                        </div>
                    </form>
                </div>
