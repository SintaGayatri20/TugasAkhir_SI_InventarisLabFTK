        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-0">
                <div class="card border-bottom-info shadow h-100 py-3">
                    <form class="form-horizontal" action="<?php echo base_url('laboran/cetakPdf'); ?>" method="post">
                        <br>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'laboran/editDataAsetRuangan/' . $as->kode_aset; ?>" class="text-success"><i class=" fas fa-edit"></i></a>
                                        </td>
                                        <td>
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('laboran/tambahDataAsetRuangan'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger" href="<?php echo base_url() . 'laboran/deleteDataAsetRuangan/' . $as->kode_aset; ?>">Hapus</a>
            </div>
        </div>
    </div>
</div>
