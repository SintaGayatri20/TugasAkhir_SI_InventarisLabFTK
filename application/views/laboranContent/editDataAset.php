         ...
         <div class="col-lg">
             <div class="content-wrapper">
                 <section class="content">
                     <form action="<?php echo base_url() . 'laboran/newEditDataAset'; ?>" method="post" enctype="multipart/form-data">
                         ...
                         <a class="btn btn-warning" href="<?= base_url('laboran/dataAset'); ?>">Back</a>
                     </form>
                 </section>
             </div>
         </div>
