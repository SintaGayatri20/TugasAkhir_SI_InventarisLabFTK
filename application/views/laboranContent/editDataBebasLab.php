         ...
         <div class="col-lg-12">
             <div class="content-wrapper">
                 <section class="content">
                     <form action="<?php echo base_url() . 'Laboran/neweditbebaslab'; ?>" method="post" enctype="multipart/form-data">
                         ...
                         <div class="form-group">
                             ...
                             <select name="id_prodi" id="id_prodi" class="form-control">
                                 ...
                                 <?php
                                    ...
                                    $hasil = $this->db->query("SELECT * FROM tb_prodi WHERE id_prodi='$id_prodi'")->result();
                                    foreach ($hasil as $h) {
                                    ?>
                         ...
                         <a class="btn btn-warning" href="<?= base_url('laboran/cetakSuratBebasLab'); ?>">Back</a>
                     </form>
                 </section>
             </div>
         </div>
