         ...
         <div class="col-lg-6">
             <div class="content-wrapper">
                 <section class="content">
                     <form action="<?php echo base_url() . 'AdminUser/newEditDataUserkoorprodi'; ?>" method="post" enctype="multipart/form-data">
                         ...
                         <div class="form-group">
                             ...
                             <?php $sts = $dataUser->email; ?>
                             <?php if ($sts = '') { ?>
                                 <input type="text" name="email" class="form-control" value="Email is empaty">
                             <?php } else { ?>
                                 <input type="text" name="email" class="form-control" value="<?= $sts; ?>">
                             <?php } ?>
                         </div>
                         <div class="form-group">
