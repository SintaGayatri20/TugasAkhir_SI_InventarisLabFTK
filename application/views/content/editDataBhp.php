         ...
         <div class="col-lg-6">
             <div class="content-wrapper">
                 <section class="content">
                     <form action="<?php echo base_url() . 'admin/neweditdatabhp'; ?>" method="post" enctype="multipart/form-data">
                         ...
                         <a class="btn btn-warning" href="<?= base_url('admin/masterbhp'); ?>">Back</a>
                     </form>
                 </section>
             </div>
         </div>
