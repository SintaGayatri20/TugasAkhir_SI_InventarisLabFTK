        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-0">
                <div class="card border-bottom-info shadow h-100 py-3">
                    <form class="form-horizontal" action="<?php echo base_url('laboranBR/savebrgRusak'); ?>" method="post">
                        <br>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($dataAset as $as) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'LaboranBR/editDataAsetRusak/' . $as->kode_aset; ?>" class="text-success"><i class=" fas fa-edit"></i></a>
                                        </td>
                                        <td>
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('LaboranBR/brgRusakRuangan'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="sel1">Lokasi Lab</label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger" href="<?php echo base_url() . 'LaboranBR/deleteDataAsetRusak/' . $as->kode_aset; ?>">Hapus</a>
            </div>
        </div>
    </div>
</div>
