         ...
         <div class="col-lg">
             <div class="content-wrapper">
                 <section class="content">
                     <form action="<?php echo base_url() . 'kaprodi/newEditDataAsetRuangan'; ?>" method="post" enctype="multipart/form-data">
                         ...
                         <a class="btn btn-warning" href="<?= base_url('kaprodi/formdataaset'); ?>">Back</a>
                     </form>
                 </section>
             </div>
         </div>
