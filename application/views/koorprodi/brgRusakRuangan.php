                            ...
                            <tbody>
                                ...
                                <?php foreach ($dataAset as $as) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'kaprodi/editDataAsetRusak/' . $as->kode_aset; ?>" class="text-success"><i class=" fas fa-edit"></i></a>
                                        </td>
                                        <td>
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('kaprodi/brgRusakRuangan'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger" href="<?php echo base_url() . 'kaprodi/deleteDataAsetRusak/' . $as->kode_aset; ?>">Hapus</a>
            </div>
        </div>
    </div>
</div>
