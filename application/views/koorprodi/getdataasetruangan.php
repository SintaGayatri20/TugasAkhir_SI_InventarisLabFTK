        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-0">
                <div class="card border-bottom-info shadow h-100 py-3">
                    <form class="form-horizontal" action="<?php echo base_url('Kaprodi/cetakPdf'); ?>" method="post">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'Kaprodi/editDataAsetRuangan/' . $as->kode_aset; ?>" class="text-success"><i class=" fas fa-edit"></i></a>
                                        </td>
                                        <td>
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('Kaprodi/tambahDataAsetRuangan'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        //$hasil = $this->db->query("SELECT * FROM tb_lokasi WHERE id_lokasi ='$getlks'")->result();
                        //foreach ($hasil as $h) {
                        ?>
                    ...
                    <div class="form-group">
                        ...
                        //$hasil = $this->db->query("SELECT * FROM tb_prodi WHERE id_prodi ='$getlks'")->result();
                        //foreach ($hasil as $h) {
                        ?>
                        <input type="hidden" class="form-control" id="id_prodi" name="id_prodi" value="<?php echo $getkat; ?>">
                        <?php //} 
                        ?>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger" href="<?php echo base_url() . 'Kaprodi/deleteDataAsetRuangan/' . $as->kode_aset; ?>">Hapus</a>
            </div>
        </div>
    </div>
</div>
