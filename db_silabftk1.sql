...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jun 07, 2021 at 02:09 PM
...
(7, 1, '198806222015041000', 1, 2, 0, ''),
(8, 2, '198806222015041000', 1, 2, 0, '');
...
(651, 28, '2', 'tes1', '<p>ree1</p>\r\n', 11, 'Pcs1', 'rusak ringan', ''),
(665, 9, '1', 'Mesin jahit 1', '<p>ZXXXX11</p>\r\n', 101, 'Meter1', '', ''),
(669, 9, '1', 'tes', '<p>zz</p>\r\n', 101, 'Meter1', 'Rusak berat', '');
...
(7, 1, 1, 6, '06/UN48.11.6/DT/2021', '11', '1991070820131002162', '2021-06-02', 'tes', '');
...
(26, 7, 'Workshop 2', 'AdminBR/dataWorkshop2', 'LaboranBR/dataWorkshop2'),
(27, 7, 'Lab 1', 'AdminBR/dataLab1', 'LaboranBR/dataLab1'),
(28, 2, 'Laboratorium Ilmu Komputer', 'AdminBR/dataLabilkom', 'LaboranBR/dataLabilkom'),
(29, 4, 'Laboratorium Sistem Informasi', 'AdminBR/dataSI', 'LaboranBR/dataSI');
...
(6, '199008152019031019', '2020-06-10', 6, 'Baik', '', 'baik segera saya perbaiki'),
...
(1, '01/UN48.11.6/DT/2021', 1805021011, '1991070820131002162', 14, 1, 1, '2021-06-01 12:05:14', '2021-06-01 12:12:05', 2, 'hut jurusan', 'Form_Peminjaman_957086.pdf', 'Form_Peminjaman_66936.pdf', 'Laporan_627962.pdf', 2, 'sudah lengkap', 'kurang tandatangan'),
(2, '02/UN48.11.6/DT/2021', 1805021011, '1991070820131002162', 14, 0, 1, '2021-06-01 12:37:56', '2021-06-01 12:41:47', 2, 'hut fakultas', 'Form_Peminjaman_304922.pdf', '', '', 2, 'sudah lengkap', '');
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `kembali_aset`;
DELIMITER $$
CREATE TRIGGER `kembali_aset` AFTER UPDATE ON `tb_peminjaman_aset` FOR EACH ROW BEGIN
...
('1234567', 'new koorprodi', 0, 'aa@gmail.com', '', '', 'koorprodi', 'default.png', 1, '2021-06-06'),
...
(2, 2, 'Ilmu Komputer', 'Teknik Informatika', '', 'AsetProdi/prodiIlkom', 'AdminBR/labIlkom', 'kaprodi//prodiIlkom', 'Teknik dan Kejuruan'),
...
(4, 2, 'Sistem Informasi', 'Teknik Informatika', '', 'AsetProdi/prodiSI', 'AdminBR/labSI', 'kaprodi/prodiSI', 'Teknik dan Kejuruan'),
...
(7, 1, 'Teknik Elektronika', 'Teknik Industri', '', 'AsetProdi/prodiTE', 'AdminBR/labTE', 'kaprodi/prodiTE', 'Teknik dan Kejuruan'),
